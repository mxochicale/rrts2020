...
are a starting point to tackle few of the previous challenges.
}
...
scientific communication based on 
continuous integration of LaTeX documents by Luger and Foreman-Mackey 2019 \cite{luger-foreman-mackey-2019-github} 
and Github actions running docker images of full TeXlive, a.k.a containers, by Xu 2020 \cite{xu2020-github}.
The open-corTeX framework involves two main steps: (a) the setting up of yml file for the github action 
and (b) Github workflow. For the latter, user usually raises an issue, creates a branch, 
...
Documents outputs for article, CV, slides, poster and thesis
using open-corTeX \cite{xochicale2020-opencortex}.
...
$\bullet$
Tools such as continuous integration 
and containers can improve reproduciblity 
due to its portability and lightweight
to produce the same output irregardless 
of the system \\  
